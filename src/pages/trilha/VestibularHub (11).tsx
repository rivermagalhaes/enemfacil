...
const SUB_TRILHAS: Record<string, { label: string; emoji: string; trilha: string; desc: string }[]> = {
  "humanas-grupo": [
    { label: "História",          emoji: "🏛️", trilha: "historia",   desc: "Pré-História · Idade Média · Brasil Colonial · Guerras" },
    { label: "Geografia",         emoji: "🗺️", trilha: "geografia",  desc: "Relevo · Clima · Urbanização · Geopolítica" },
    { label: "Filosofia & Sociol.",emoji: "🧠", trilha: "filosofia",  desc: "Contratualistas · Marx · Weber · Cidadania" },
  ],
  "quimica-grupo": [
...
const MATERIAS: Record<string, { id: string; label: string; emoji: string; trilha: string; desc: string; grupo?: string }[]> = {
  ...
  ENEM: [
    ...
    { id: "humanas",    label: "Humanas",      emoji: "🌍", trilha: "",               desc: "História · Geografia · Filosofia", grupo: "humanas-grupo" },
