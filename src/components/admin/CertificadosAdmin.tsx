...
interface Template { id: string; nome: string; cor_primaria: string; cor_secundaria: string; assinatura1_nome?: string; assinatura1_cargo?: string; assinatura1_url?: string; assinatura2_nome?: string; assinatura2_cargo?: string; logo_url?: string; }
