...
<div class="certificado">
  ...
  <!-- Corpo -->
  <div class="corpo">
    ${dados.brasao_url ? `<img src="${dados.brasao_url}" style="height:70px;margin-bottom:8px;display:block;margin-left:auto;margin-right:auto;" />` : ""}
    ...
    <div class="assinaturas">
      ...
      <div class="assinatura">
        ${dados.assinatura1_url ? `<img src="${dados.assinatura1_url}" style="height:80px;margin-bottom:6px;display:block;margin-left:auto;margin-right:auto;" />` : ""}
      ...
      ${assin2Nome ? `
      <div class="assinatura">
        ${dados.assinatura2_url ? `<img src="${dados.assinatura2_url}" style="height:80px;margin-bottom:6px;display:block;margin-left:auto;margin-right:auto;" />` : ""}
        <div class="assinatura-linha"></div>
...
serve(async (req) => {
  ...
  try {
    ...
    const html = gerarHTMLCertificado({
      ...
      brasao_url:      template?.brasao_url,
    });
